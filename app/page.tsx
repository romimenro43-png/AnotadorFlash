...
export default function Home() {
  ...
  return (
    <main className="app-shell" onPaste={pasteImage}>
      ...
      {showBanner && <div className="notice"><Icon name="bell" /><span>Pasaron 30 minutos — tenés <strong>{tasks.length} tareas</strong> para pasar en limpio. Revisalas y guardá la reunión cuando termines.</span><button onClick={() => setShowBanner(false)} aria-label="Cerrar aviso"><Icon name="x" /></button></div>}
